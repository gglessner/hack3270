...
### New Feature: MCP Server for AI-Assisted Pen Testing (`mcp_server.py`)
...
#### Architecture
```
[AI Agent] <--stdio/JSON-RPC--> [mcp_server.py] <--TCP:31337--> [hack3270 Proxy] <--TN3270--> [Mainframe]
```
